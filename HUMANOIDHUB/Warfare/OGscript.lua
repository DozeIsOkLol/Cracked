...
local function VerifyPhantomKey(key)
    local status, result = pcall(function()
        ...
        local formula = (num * num) % 10000
        return suffix == string.format("%04d", formula)
    end)
...
Instance.new("UIStroke", KeyMain).Color = Color3.fromRGB(255, 0, 0)
...
KeyBox.BackgroundColor3 = Color3.fromRGB(25, 25, 25); KeyBox.TextColor3 = Color3.new(1,1,1); KeyBox.Text = ""
Instance.new("UICorner", KeyBox)

local GetKeyBtn = Instance.new("TextButton", KeyMain)
GetKeyBtn.Size = UDim2.new(0, 260, 0, 35); GetKeyBtn.Position = UDim2.new(0.5, -130, 0, 110); GetKeyBtn.Text = "GET KEY (ADS)"
GetKeyBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40); GetKeyBtn.TextColor3 = Color3.new(1,1,1)
Instance.new("UICorner", GetKeyBtn)

GetKeyBtn.MouseButton1Click:Connect(function()
    -- İSTEDİĞİN YENİ LİNK BURAYA EKLENDİ --
    setclipboard("https://linkvertise.com/3601903/akoBvpTErJ98?o=sharingc") 
    GetKeyBtn.Text = "LINK COPIED!"
    task.wait(2)
    GetKeyBtn.Text = "GET KEY (ADS)"
end)
...
Submit.BackgroundColor3 = Color3.fromRGB(200, 0, 0); Submit.TextColor3 = Color3.new(1,1,1)
Instance.new("UICorner", Submit)

-- [[ 🚀 DOĞRULAMA SONRASI SENİN ORİJİNAL KODUN ]] --
Submit.MouseButton1Click:Connect(function()
    if VerifyPhantomKey(KeyBox.Text) then
        KeyGui:Destroy()
        
        -- Buradan sonrası senin orijinal fonksiyonların, hiçbirine dokunulmadı --
        ...
        task.delay(5, function() Main.Visible = true end)
                ...
                if p ~= LocalPlayer and p.Character and p.Character:FindFirstChild("Head") then
                    ...
                    if hum and hum.Health > 0 then
                        ...
                        if vis then
                            ...
                            if mag < dist then target = head; dist = mag end
                        end
                    end
                end
            end
        ...
        RunService.RenderStepped:Connect(function()
            ...
            for _, p in pairs(Players:GetPlayers()) do
                if p ~= LocalPlayer and p.Character then
                    ...
                    if _G.Chams then
                        if not hl then
                            hl = Instance.new("Highlight", char); hl.Name = "HumanoidChams"
                            hl.FillColor = Color3.fromRGB(255, 0, 0); hl.FillTransparency = 0.5; hl.DepthMode = "AlwaysOnTop"
                        end
                    ...
                    if head then
                        ...
                        if _G.ESP then
                            if not tag then
                                tag = Instance.new("BillboardGui", head); tag.Name = "HumanoidTag"; tag.AlwaysOnTop = true
                                tag.Size = UDim2.new(0, 50, 0, 8); tag.StudsOffset = Vector3.new(0, 3, 0)
                                local b = Instance.new("Frame", tag); b.Size = UDim2.new(1, 0, 1, 0); b.BackgroundColor3 = Color3.new(0,0,0)
                                local f = Instance.new("Frame", b); f.Name = "Fill"; f.Size = UDim2.new(1,0,1,0); f.BackgroundColor3 = Color3.new(0,1,0); f.BorderSizePixel = 0
                                Instance.new("UICorner", b); Instance.new("UICorner", f)
                            end
                            local hum = char:FindFirstChildOfClass("Humanoid")
                            if hum then tag.Frame.Fill.Size = UDim2.new(hum.Health/hum.MaxHealth, 0, 1, 0) end
